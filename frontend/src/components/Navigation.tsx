            ...
            {userEmail && (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/20 border border-amber-500/30 hover:bg-amber-500/30 transition-colors"
                >
                  <User size={14} className="text-amber-400" />
                  <span className="text-xs text-amber-200 hidden sm:inline max-w-[100px] truncate">{userEmail.split("@")[0]}</span>
                </button>
                
                {showUserMenu && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-zinc-900 border border-white/10 rounded-lg shadow-xl py-1 z-50">
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="pt-4 border-t border-white/5 flex items-center gap-4">
                ...
                {userEmail ? (
                  ...
                  <button onClick={() => setShowSignIn(true)} className="text-white text-sm">Sign In</button>
                )}
              </div>
            </div>
          </div>
