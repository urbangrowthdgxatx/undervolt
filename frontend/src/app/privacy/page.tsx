        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6">
          <section>
            ...
            <p className="text-white/70">
              Undervolt ("we", "our", "us") is an open-source energy infrastructure analytics platform. 
          ...
          <section>
            ...
            <p className="text-white/70">
              ...
              on NVIDIA Jetson hardware — your queries are not sent to external AI providers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-white/70">
              Undervolt is open source under the MIT license. You can review our code and data handling 
              practices on{" "}
              <a href="https://github.com/urbangrowthdgxatx/undervolt" className="text-emerald-400 hover:underline">
                GitHub
              </a>.
            </p>
          </section>
