...
const LOGOS: Record<string, React.ReactNode> = {
  ...
  ollama: <svg className="w-5 h-5" viewBox="0 0 32 32" fill="white"><ellipse cx="16" cy="14" rx="10" ry="9"/><ellipse cx="16" cy="24" rx="6" ry="4"/><circle cx="12" cy="12" r="2" fill="black"/><circle cx="20" cy="12" r="2" fill="black"/></svg>,
