...
const LOGOS: Record<string, React.ReactNode> = {
  nvidia: <span className="w-5 h-5 flex items-center justify-center text-[10px] font-bold bg-[#76B900] text-white rounded">N</span>,
  ollama: <span className="w-5 h-5 flex items-center justify-center text-[10px] font-bold bg-white text-black rounded">O</span>,
