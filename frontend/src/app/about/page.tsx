...
const LOGOS: Record<string, React.ReactNode> = {
  nvidia: <span className="w-5 h-5 flex items-center justify-center text-[10px] font-bold bg-white/10 text-[#76B900] rounded">N</span>,
  ollama: <span className="w-5 h-5 flex items-center justify-center text-[10px] font-bold bg-white/10 text-white/70 rounded">O</span>,
    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-xl bg-gradient-to-r from-white/5 to-white/[0.02] border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <a 
          ...
          target="_blank"
          className="px-5 py-2.5 bg-white/10 text-white/70 font-medium rounded-lg hover:bg-white/90 transition-colors text-sm"
        >
          View on GitHub
        </a>
      </div>
    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 text-white/70 rounded-lg font-medium hover:bg-white/90 transition-all text-sm"
        >
          Get in Touch
          <ArrowRight className="w-4 h-4" />
        </a>
