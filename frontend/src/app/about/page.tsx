...
const LOGOS: Record<string, React.ReactNode> = {
  ...
  ollama: <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.5 2 6 4.5 6 7.5c0 1.5.5 2.8 1.3 3.8-.8.7-1.3 1.7-1.3 2.7 0 2 1.5 3.5 3.5 4v2.5c0 .8.7 1.5 1.5 1.5h2c.8 0 1.5-.7 1.5-1.5V18c2-.5 3.5-2 3.5-4 0-1-.5-2-1.3-2.7.8-1 1.3-2.3 1.3-3.8C18 4.5 15.5 2 12 2zm-1.5 5c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm3 0c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1z"/></svg>,
