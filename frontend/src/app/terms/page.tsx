      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-white/70">
              Undervolt is an open-source platform that analyzes public construction permit data from Austin, Texas 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-white/70 space-y-2">
              <li>AI responses are generated by Nemotron model running on NVIDIA Jetson</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-white/70 space-y-2">
              <li>Undervolt is open source under the MIT license</li>
              <li>You may fork, modify, and distribute the code</li>
              <li>The Undervolt name and logo are our trademarks</li>
              <li>Permit data is public domain from Austin city</li>
            </ul>
          </section>
