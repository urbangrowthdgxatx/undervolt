        ...
        <div className="flex-1 flex items-center justify-center px-8">
          <div className="max-w-4xl text-center">
            ...
            <div className="relative overflow-hidden w-full max-w-lg mx-auto mt-6">
              ...
              {/* NVIDIA */}
              <a href="https://developer.nvidia.com/embedded/jetson-agx-orin" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-50 hover:opacity-70 transition-opacity flex-shrink-0">
              ...
              {/* Ollama */}
              <a href="https://ollama.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-50 hover:opacity-70 transition-opacity flex-shrink-0">
                <img src="/ollama.png" alt="Ollama" className="w-8 h-8 rounded invert" />
                <span className="text-xs text-white/50">Ollama</span>
              </a>

              {/* Supabase */}
              <a href="https://supabase.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-50 hover:opacity-70 transition-opacity flex-shrink-0">
              ...
              {/* Next.js */}
              <a href="https://nextjs.org" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-50 hover:opacity-70 transition-opacity flex-shrink-0">
              ...
              {/* Vercel */}
              <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-50 hover:opacity-70 transition-opacity flex-shrink-0">
                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
