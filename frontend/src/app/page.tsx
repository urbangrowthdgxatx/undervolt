        ...
        <div className="flex-1 flex items-center justify-center px-8">
          <div className="max-w-4xl text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-500/20 to-yellow-500/20 border border-amber-500/40 mb-6">
              ...
              <span className="text-sm text-amber-300 font-medium">1st Place Urban Growth - NVIDIA DGX AITX Hackathon · Dec 2025</span>
            </div>
            ...
            <div className="relative overflow-hidden w-full max-w-lg mx-auto mt-6">
              ...
              {/* NVIDIA */}
              <a href="https://developer.nvidia.com/embedded/jetson-agx-orin" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-90 hover:opacity-100 transition-opacity flex-shrink-0">
                <img src="/nvidia-logo.png" alt="NVIDIA" className="w-14 h-8 object-contain rounded" />
                <span className="text-xs text-white/80">NVIDIA</span>
              </a>

              {/* Ollama */}
              <a href="https://ollama.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-90 hover:opacity-100 transition-opacity flex-shrink-0">
                <img src="/ollama.png" alt="Ollama" className="w-8 h-8 rounded invert" />
                <span className="text-xs text-white/80">Ollama</span>
              </a>

              {/* Supabase */}
              <a href="https://supabase.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-90 hover:opacity-100 transition-opacity flex-shrink-0">
              ...
              {/* Next.js */}
              <a href="https://nextjs.org" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-90 hover:opacity-100 transition-opacity flex-shrink-0">
              ...
              {/* Vercel */}
              <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-90 hover:opacity-100 transition-opacity flex-shrink-0">
                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2L2 19.5h20L12 2z"/>
                </svg>
                <span className="text-xs text-white/80">Vercel</span>
              </a>
              </div>
          </div>
        </div>
