...
import { Battery, AlertTriangle, Users, BarChart3, ArrowRight, Sun, Snowflake, TrendingUp, MapPin } from "lucide-react";
...
function Overview() {
  ...
  const energyBreakdown = {
    type: "bar" as const,
    title: "Energy Infrastructure (2024)",
    data: [
      { name: "Solar", value: 25982 },
      { name: "Generator", value: 7293 },
      { name: "EV", value: 3642 },
      { name: "Battery", value: 1181 },
    ]
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center py-8">
        <div className="text-7xl md:text-8xl font-bold text-amber-400 mb-2">22:1</div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="p-6 rounded-xl bg-amber-500/10 border border-amber-500/20 text-center">
          ...
          <div className="text-4xl font-bold text-amber-400 mb-1">25,982</div>
        ...
        <div className="p-6 rounded-xl bg-white/[0.02] border border-white/10 text-center">
          ...
          <div className="text-4xl font-bold text-white/30 mb-1">~1,180</div>
      ...
      <Link
        ...
        className="flex items-center justify-center gap-2 w-full p-4 bg-amber-500 text-black rounded-lg font-medium hover:bg-amber-400 transition-colors"
      >
        Explore Battery Data <ArrowRight className="w-4 h-4" />
      </Link>
    </div>
  );
}
    ...
    <div className="space-y-8">
      ...
      <div className="p-4 rounded-lg border-l-4 border-red-500 bg-white/[0.02]">
        <p className="text-white/60 text-sm italic">
          ...
          that could afford the $5,000-$15,000 investment."
        </p>
      </div>
      ...
      <Link
        ...
        className="flex items-center justify-center gap-2 w-full p-4 bg-red-500 text-white rounded-lg font-medium hover:bg-red-400 transition-colors"
      >
        Explore Generator Data <ArrowRight className="w-4 h-4" />
      </Link>
    </div>
  );
}
    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-0">
        <div className="p-8 rounded-l-xl bg-blue-500/10 border border-blue-500/20 text-center">
          <div className="text-white/40 text-sm mb-4">District 10 / Westlake</div>
        ...
        <div className="p-8 rounded-r-xl bg-white/[0.02] border border-white/10 text-center">
          <div className="text-white/40 text-sm mb-4">East Austin</div>
      ...
      <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5">
        ...
        <p className="text-white/60 leading-relaxed">
          After the 2021 freeze, wealthier neighborhoods rapidly added backup power.
          Communities with fewer resources—often the same areas hit hardest by outages—couldn't
          make the same investments. This data makes the disparity visible.
        </p>
      </div>

      <Link
        href="/dashboard?filter=generator"
        className="flex items-center justify-center gap-2 w-full p-4 bg-blue-500 text-white rounded-lg font-medium hover:bg-blue-400 transition-colors"
      >
        Explore by District <ArrowRight className="w-4 h-4" />
      </Link>
    </div>
  );
}
