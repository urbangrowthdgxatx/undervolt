...
const stories = [
  ...
  },
  {
    ...
    color: "blue",
    filter: "battery",
    description: "For every 22 solar panels, there's just 1 battery. When the sun sets—or the grid fails—that energy vanishes."
  },
  {
    id: "generator",
    title: "Trust, Broken",
...
function transformFeature(feature: any, index: number) {
  ...
  return {
    ...
    lng: coords[0],
    signal,
    description: props.cluster_name || "Permit",
    zip: props.zip_code || "",
